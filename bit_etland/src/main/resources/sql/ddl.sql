...
-- 프로덕트 만드는곳
INSERT INTO Products(PRODUCT_NAME,SUPPLIER_ID,CATEGORY_ID,UNIT,PRICE) VALUES('samsung','4000','5000','1',1000000);
-- 이미지 디폴트 인설트한곳
...
-- Employees
INSERT INTO EMPLOYEES(MANAGER,NAME,BIRTHDATE,PHOTO,NOTES) VALUES('manager','김경민','880922-2','defaule_photo','매니저');